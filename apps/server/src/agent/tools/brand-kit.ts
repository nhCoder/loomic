...
export function createBrandKitTool(
  ...
  return tool(
    ...
    },
    {
      name: "get_brand_kit",
      description:
        "Query the brand kit linked to the current project, including design guidance, colors, fonts, logos, and other brand assets. Use this tool when the user mentions brand, style, or design guidelines.",
