  ...
  return (
    <div className="px-4 py-6 sm:px-6 md:p-8">
      ...
      <p className="mt-1 mb-4 text-xs text-muted-foreground sm:mb-6 sm:text-sm">
        Give your agent reusable best practices and tools
      </p>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                Add skills to unlock new capabilities for your agent
              </p>
            </div>
          ...
          {filteredSkills.length === 0 ? (
            ...
            >
              ...
              <p className="text-sm font-medium text-foreground">
                {hasActiveFilters ? "No matching skills found" : "No skills yet"}
              </p>
              <p className="mt-1 text-xs text-muted-foreground">
                {hasActiveFilters
                  ? "Try adjusting your search or filters"
                  : "Create a custom skill to extend your agent"}
              </p>
            </motion.div>
          ) : (
            <motion.div
