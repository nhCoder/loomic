...
const PRESET_SKILLS: Skill[] = [
  {
    ...
    prompt: "Design a social media carousel with a cover and multiple inner pages in a consistent style",
  },
  {
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none">
    ...
    label: "Social media",
    prompt: "Design a modern, clean social media poster",
  },
  {
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none">
    ...
    prompt: "Design a logo and brand visual system",
  },
  {
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none">
    ...
    label: "Storyboard",
    prompt: "Create a storyboard to present a creative concept",
  },
  {
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    prompt: "Design product showcase images for e-commerce",
  },
];
