...
const TOOL_CONFIG: Record<string, ToolDisplayConfig> = {
  ...
  inspect_canvas: { label: "Inspect canvas", icon: "eye", showCard: true },
  manipulate_canvas: { label: "Update canvas", icon: "brush", showCard: true },
  generate_image: { label: "Generate image", icon: "image", showCard: true },
  generate_video: { label: "Generate video", icon: "video", showCard: true },
  screenshot_canvas: { label: "Capture canvas", icon: "eye", showCard: true },
  get_brand_kit: { label: "Brand kit", icon: "palette", showCard: true },
  project_search: { label: "Search project", icon: "search", showCard: true },
  task: { label: "Run task", icon: "tool", showCard: false },
};
