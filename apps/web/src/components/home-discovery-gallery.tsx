    ...
    <section className="mt-14 w-full">
      <div className="mb-5 flex flex-col gap-4">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h2 className="text-lg font-medium text-foreground">Inspiration discovery</h2>
            <p className="mt-1 text-sm text-muted-foreground">
              Click a card to create a Loomic project from that idea and enter the agent conversation.
            </p>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between gap-3 px-4 py-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-left text-xs text-muted-foreground">
                  Click to use as Loomic's starting brief
                </p>
              </div>

              <div className="flex shrink-0 items-center gap-3 text-xs text-muted-foreground">
                <span>{formatMetric(item.viewCount)} views</span>
