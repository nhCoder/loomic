...
export const MODEL_MIN_TIER: Record<string, SubscriptionPlan> = {
  ...
  // Free tier (OpenAI GPT Image)
  "openai-official/gpt-image-2": "free",
  "openai-official/gpt-image-1.5": "free",
  "openai-official/gpt-image-1": "free",
  "openai-official/gpt-image-1-mini": "free",
...
export const IMAGE_MODEL_COSTS: Record<string, ImageModelCost> = {
  ...
  // OpenAI Official
  "openai-official/gpt-image-2": { standard: 0, hd: 0, ultra: 0 },
  "openai-official/gpt-image-1.5": { standard: 0, hd: 0, ultra: 0 },
  "openai-official/gpt-image-1": { standard: 0, hd: 0, ultra: 0 },
  "openai-official/gpt-image-1-mini": { standard: 0, hd: 0, ultra: 0 },
  // Replicate — OpenAI
  "openai/gpt-image-1.5": { standard: 0, hd: 0, ultra: 0 },
  // Replicate — BFL
